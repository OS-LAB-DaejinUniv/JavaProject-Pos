    ...
    public static void main(String[] args) {
        ...
        while (true) {
            if (isAdmin) {
                ...
                admin.adminMenu();
                isAdmin = false; // Reset isAdmin to return to user menu
            }
                ...
                switch (num) {
                    ...
                    case "5" -> {
                        ...
                        if (confirm.equalsIgnoreCase("Yes")) {
                            ...
                            try {
                                OrderLogger.logOrder(allSelectedMenus, totalPrice);
                                System.out.println("주문 내역이 기록되었습니다.");
                            } catch (IOException e) {
                                System.out.println("주문 내역을 기록하는 중 오류가 발생했습니다.");
                            }
